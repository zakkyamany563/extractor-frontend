    ...
    return (
        <div className="min-h-screen flex flex-col gap-4 w-full font-sans bg-neutral-100 p-4 ">
            ...
            <div className="w-full bg-white flex flex-row  justify-between items-center p-4 fixed top-0 left-0 z-10">
                <div className="text-blue-400 font-bold text-4xl flex flex-row items-center gap-2">
                    <PiVideoFill />
                    <div>
                        <div>
                        ...
                        <div className="text-gray-700 text-sm pl-1 flex flex-row items-center gap-1">
                            <SiOpenai />
                            Powered by OpenAI
                        </div>
                    </div>
                ...
                <div className="flex flex-row gap-4 items-center">
                    <button className="bg-neutral-200 p-3 rounded-xl flex flex-row items-center gap-1">
                        <TbRosetteDiscount />
                        Free Use
                    </button>
                    <button className="bg-gradient-to-r from-red-500 to-red-400 text-white p-3 rounded-xl flex flex-row items-center gap-1 hover:from-pink-400 hover:to-pink-500 ">
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/3 bg-white rounded-xl shadow-xl p-4 flex flex-col gap-4">
                        ...
                        :null
                            ...
                            <DialogContent className="w-[80vw] max-h-[80vh] overflow-auto">
                                <DialogHeader>
                                    <DialogTitle className="text-4xl mb-2">Result</DialogTitle>
                                    <DialogDescription>
